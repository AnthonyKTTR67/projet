...
unsigned long lastReconnectAttempt = 0; // Temps de la dernière tentative de reconnexion
const unsigned long reconnectInterval = 5000; // Intervalle entre les tentatives de reconnexion (5 secondes)
...
void loop() {
  ...
  // Envoyer les données à MQTT à intervalle régulier
