...
void reconnectMQTT() {
  while (!clientMQTT.connected()) {                         // Boucle qui continue tant que le client MQTT n'est pas connecté
    Serial.print("Tentative de connexion MQTT...");          // Génération d'un identifiant unique pour le client MQTT, L'identifiant est important pour que le serveur MQTT puisse distinguer les clients
